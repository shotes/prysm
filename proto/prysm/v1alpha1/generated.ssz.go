...
// Hash: 5ebf8b5a0edaf5de61f82f703c6646891a5375726867dca26f21f8a5e1e6ca59
package eth
...
func (i *IndexedAttestationElectra) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (0) 'AttestingIndices'
	{
		...
		numItems := uint64(len(i.AttestingIndices))
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(131072, numItems, 8))
		} else {
...
func (b *BeaconBlockBodyElectra) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (4) 'AttesterSlashings'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, num, 1)
		} else {
	...
	// Field (5) 'Attestations'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, num, 8)
		} else {
...
func (b *BeaconStateElectra) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (34) 'PendingBalanceDeposits'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, num, 134217728)
		} else {
	...
	// Field (36) 'PendingConsolidations'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, num, 262144)
		} else {
...
func (b *BeaconStateEPBS) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (27) 'DepositReceiptsStartIndex'
	dst = ssz.MarshalUint64(dst, b.DepositReceiptsStartIndex)
	...
	// Offset (33) 'PendingBalanceDeposits'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PendingBalanceDeposits) * 16
	...
	// Field (33) 'PendingBalanceDeposits'
	if size := len(b.PendingBalanceDeposits); size > 134217728 {
		err = ssz.ErrListTooBigFn("--.PendingBalanceDeposits", size, 134217728)
		return
	}
...
func (b *BeaconStateEPBS) UnmarshalSSZ(buf []byte) error {
	...
	// Field (27) 'DepositReceiptsStartIndex'
	b.DepositReceiptsStartIndex = ssz.UnmarshallUint64(buf[2736649:2736657])
...
func (b *BlindPayloadEnvelope) UnmarshalSSZ(buf []byte) error {
	...
	// Field (7) 'PayloadWithheld'
	b.PayloadWithheld = ssz.UnmarshalBool(buf[188:189])
